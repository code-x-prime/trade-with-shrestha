...
export default function CreateBundlePage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await bundleAPI.create(submitData);
            if (response.success) {
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
            <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground">Combine multiple courses into a discounted package</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <CardContent>
                        {loadingCourses ? (
                            ...
                            <div className="text-center py-8 text-muted-foreground">
                                ...
                                <p className="text-sm">Create and publish courses first</p>
                            </div>
                        ) : (
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        {selectedCourses.length >= 2 && formData.price && (
