...
export default function EditCorporateTrainingPage() {
  ...
  const fetchTraining = async () => {
    try {
      const res = await corporateTrainingAPI.getById(id);
      if (res.success) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setSubmitting(true);
      await corporateTrainingAPI.update(id, {
        ...formData,
  ...
  return (
    <div className="max-w-5xl mx-auto pb-10">
      <div className="mb-6">
        <h1 className="text-2xl font-bold">Edit Training Program</h1>
        <p className="text-muted-foreground">Update corporate training details</p>
      </div>
