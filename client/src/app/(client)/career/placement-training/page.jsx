          ...
          <Card className="rounded-3xl border border-border/80 bg-gradient-to-br from-fuchsia-600/10 via-background to-violet-600/10 overflow-hidden">
            <CardContent className="p-6 md:p-8">
              <div className="flex items-center justify-between gap-4 flex-wrap">
                <div>
                  <Badge className="bg-fuchsia-600 hover:bg-fuchsia-700">Event banner</Badge>
                  <h2 className="text-2xl md:text-3xl font-bold mt-3 tracking-tight">An Immersive Learning Experience</h2>
                  <p className="text-muted-foreground mt-2 max-w-xl">
                    Professional UI + illustration placeholder (you can replace later).
                  </p>
                </div>
                <div className="h-24 w-24 rounded-2xl bg-background/60 border border-border/60 flex items-center justify-center text-muted-foreground">
                  Image
                </div>
              </div>
            </CardContent>
