        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <Button size="lg" variant="outline" className="border-white text-black hover:bg-white/10" onClick={() => document.getElementById('programs').scrollIntoView({ behavior: 'smooth' })}>
                Explore Programs
              </Button>
            </div>
          </div>
          <div className="hidden md:block relative h-[400px]">
             ...
             <div className="absolute inset-0 bg-gradient-to-tr from-blue-500/20 to-purple-500/20 rounded-2xl backdrop-blur-sm border border-white/10 flex items-center justify-center">
                <div className="text-center p-8">
                    <div className="text-6xl mb-4">🚀</div>
                    <h3 className="text-2xl font-bold">Industry Ready Skills</h3>
                    <p className="mt-2 text-blue-100">Practical, project-based learning for real-world impact.</p>
                </div>
             </div>
          </div>
        </div>
